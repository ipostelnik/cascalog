...
public class MultiGroupBy extends SubAssembly {
    ...
    public MultiGroupBy(Pipe[] pipes, Fields groupFields, int pipeFieldsSum,
        MultiBuffer operation) {
    ...
    public MultiGroupBy(Pipe[] pipes, Fields[] groupFields, int pipeFieldsSum,
        Fields groupingRename, MultiBuffer operation) {
        init(pipes, groupFields, pipeFieldsSum, groupingRename, operation);
    }

    protected void init(Pipe[] pipes, Fields[] groupFields, int pipeFieldsSum,
        Fields groupingRename, MultiBuffer operation) {
